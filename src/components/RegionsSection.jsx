...
// City positions computed from geoViewBox="26.648880 48.495697 30.181636 45.461699", size 612.55×768.87
// x = (lon - 26.6489) / 3.5328 * 612.55,  y = (48.4957 - lat) / 3.034 * 768.87
const regions = [
  {
    id: 'chisinau', name: 'Кишинёв', nameEn: 'Chisinau', x: 383, y: 377,
    vacancies: 1240, partners: 86, participants: 3200,
    topTracks: ['IT', 'Сфера услуг', 'Предпринимательство'], topTracksEn: ['IT', 'Services', 'Entrepreneurship'],
    color: '#3B82F6',
  },
  {
    id: 'balti', name: 'Бельцы', nameEn: 'Bălți', x: 222, y: 187,
    vacancies: 420, partners: 31, participants: 980,
    topTracks: ['Производство', 'Агросектор', 'IT'], topTracksEn: ['Manufacturing', 'Agro-sector', 'IT'],
    color: '#10B981',
  },
  {
    id: 'cahul', name: 'Кагул', nameEn: 'Cahul', x: 268, y: 658,
    vacancies: 185, partners: 14, participants: 410,
    topTracks: ['Агросектор', 'Сфера услуг', 'Производство'], topTracksEn: ['Agro-sector', 'Services', 'Manufacturing'],
    color: '#fbbf24',
  },
  {
    id: 'orhei', name: 'Оргеев', nameEn: 'Orhei', x: 377, y: 283,
    vacancies: 210, partners: 18, participants: 520,
    topTracks: ['Агросектор', 'Производство', 'IT'], topTracksEn: ['Agro-sector', 'Manufacturing', 'IT'],
    color: '#a78bfa',
  },
  {
    id: 'ungheni', name: 'Унгены', nameEn: 'Ungheni', x: 220, y: 308,
    vacancies: 160, partners: 12, participants: 390,
    topTracks: ['Производство', 'Агросектор', 'Сфера услуг'], topTracksEn: ['Manufacturing', 'Agro-sector', 'Services'],
    color: '#f472b6',
  },
  {
    id: 'soroca', name: 'Сорока', nameEn: 'Soroca', x: 284, y: 88,
    vacancies: 130, partners: 10, participants: 310,
    topTracks: ['Производство', 'Агросектор', 'IT'], topTracksEn: ['Manufacturing', 'Agro-sector', 'IT'],
    color: '#38bdf8',
  },
  {
    id: 'hincesti', name: 'Хынчешть', nameEn: 'Hîncești', x: 336, y: 422,
    vacancies: 145, partners: 11, participants: 340,
    topTracks: ['Агросектор', 'Производство', 'Сфера услуг'], topTracksEn: ['Agro-sector', 'Manufacturing', 'Services'],
    color: '#34d399',
  },
  {
    id: 'edinet', name: 'Единец', nameEn: 'Edineț', x: 114, y: 83,
    vacancies: 98, partners: 8, participants: 240,
    topTracks: ['Агросектор', 'Производство'], topTracksEn: ['Agro-sector', 'Manufacturing'],
    color: '#fb923c',
  },
  {
    id: 'comrat', name: 'Комрат', nameEn: 'Comrat', x: 349, y: 556,
    vacancies: 112, partners: 9, participants: 275,
    topTracks: ['Агросектор', 'Производство', 'Сфера услуг'], topTracksEn: ['Agro-sector', 'Manufacturing', 'Services'],
    color: '#e879f9',
  },
  {
    id: 'tiraspol', name: 'Тирасполь', nameEn: 'Tiraspol', x: 518, y: 419,
    vacancies: 95, partners: 7, participants: 210,
    topTracks: ['Производство', 'IT'], topTracksEn: ['Manufacturing', 'IT'],
    color: '#94a3b8',
  },
]

// Real district paths from official MapSVG Moldova data
const DISTRICTS = [
  { id: 'MD-AN', d: 'm 422.98557,446.86142 0.31,-0.97 0,0 0.85,-13.13 -1.36,-8.86 -3.58,-5.12 -4.44,1.02 -2.64,2.31 0,0 0,0 0,0 2.05,-9.64 -1.54,-3.06 -4.6,-5.12 -5.28,-0.68 -1.71,-2.56 0.85,-7.5 3.58,-4.6 0,0 -0.85,-3.4 4.94,-4.02 11.26,-1.53 1.53,1.36 0,0 1.19,2.05 0,0 1.2,5.62 0,0 3.07,3.07 2.38,-0.85 2.73,-3.24 0,0 6.48,-8.53 9.03,-0.85 1.54,-1.19 0.68,-5.8 -1.02,-6.82 1.53,-2.9 4.43,-2.55 1.88,-6.31 0,0 2.05,0 0,0 2.89,0.94 9.21,9.71 2.39,6.14 -0.34,4.09 -3.07,6.99 2.04,3.92 0,0 -1.19,2.05 0,0 -7.67,-2.39 -2.56,0.34 -0.68,6.14 0,0 1.02,2.56 0,0 4.78,3.92 0,0 6.64,2.73 0,0 3.76,-1.88 0,0 3.58,-2.21 0,0 3.58,-1.88 5.96,2.39 2.22,2.56 0,0 -0.51,3.58 0,0 -2.22,3.41 1.02,3.75 0,0 2.39,5.62 0,0 -1.7,3.41 -1.03,-2.9 0,0 -0.34,-1.7 -1.53,0 -0.51,-1.19 1.19,-0.52 -1.36,-1.19 0,0 -9.21,-0.85 -0.85,1.7 0,0 -1.03,2.39 0,0 0,3.92 -1.53,2.73 2.39,4.6 0,0 1.36,1.71 0,0 2.22,5.79 0,0 -17.56,-0.51 0,0 -7.5,6.48 -6.65,1.7 -4.95,4.95 0,0 -0.17,3.41 2.05,4.26 -0.68,4.43 0,0 -5.63,-0.17 -2.39,-2.21 0,0 -1.53,-2.73 0,0 -4.43,-5.29 -4.78,-1.87 z' },
...
export default function RegionsSection() {
  ...
  return (
    <section className="section" id="regions" style={{ borderTop: '1px solid var(--border)' }}>
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <span className="tag tag-green" style={{ marginBottom: 16, display: 'inline-block' }}>
            {en ? 'Program map' : 'Карта программы'}
          </span>
          <h2 style={{ fontSize: 'clamp(24px, 4vw, 40px)', fontWeight: 800, color: 'var(--text)', margin: '0 0 14px 0', letterSpacing: '-0.5px' }}>
            {en ? 'Program across all regions of Moldova' : 'Программа во всех регионах Молдовы'}
          </h2>
          <p style={{ color: 'var(--text-2)', fontSize: 15, maxWidth: 520, margin: '0 auto' }}>
            {en ? 'Click a region to see vacancies, partners and tracks' : 'Нажмите на регион, чтобы увидеть вакансии, партнёров и треки'}
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 32, alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <svg viewBox="0 0 612.55 768.87" style={{ width: '100%', maxWidth: 340, height: 'auto' }}>
              <defs>
                {/* Filter: merges all district fills into one shape, adds outer border only */}
                <filter id="countryOutline" x="-4%" y="-4%" width="108%" height="108%">
                  {/* Dilate the combined alpha to get outer border area */}
                  <feMorphology in="SourceAlpha" operator="dilate" radius="2" result="dilated" />
                  {/* Color the dilated area with border color */}
                  <feFlood floodColor="#94a3b8" floodOpacity="0.7" result="borderColor" />
                  <feComposite in="borderColor" in2="dilated" operator="in" result="border" />
                  {/* Stack: border behind original graphic */}
                  <feMerge>
                    <feMergeNode in="border" />
                    <feMergeNode in="SourceGraphic" />
                  </feMerge>
                </filter>
                {/* Soft drop shadow for the whole country */}
              ...
              <g filter="url(#countryShadow)">
                {DISTRICTS.map(dist => (
                  <path key={dist.id + '-shadow'} d={dist.d}
                    fill="var(--bg-el)" stroke="none" />
                ))}
              </g>

              {/* All districts merged — same fill+stroke hides internal borders, filter adds outer border */}
              <g filter="url(#countryOutline)">
                {DISTRICTS.map(dist => (
                  <path key={dist.id} d={dist.d}
                    fill="var(--bg-el)"
                    stroke="var(--bg-el)"
                    strokeWidth="3"
              ...
              {regions.map(r => {
                ...
                return (
                  ...
                  >
                    {active && (
                      <circle cx={r.x} cy={r.y} r={28} fill={r.color} fillOpacity="0.15" />
                    )}
                    <circle
                      cx={r.x} cy={r.y} r={active ? 13 : 9}
                      fill={active ? r.color : 'var(--bg-el)'}
                      stroke={r.color} strokeWidth={active ? 0 : 2.5}
                      style={{ transition: 'all 0.2s' }}
                    />
                    {(active || r.id === 'chisinau') && (
                      <text x={r.x} y={r.y - 18} textAnchor="middle"
                        fill={active ? r.color : 'var(--text-2)'}
                        fontSize="16" fontWeight="700" fontFamily="Inter, sans-serif"
                        style={{ paintOrder: 'stroke', stroke: 'var(--bg)', strokeWidth: 4 }}
                      >{en ? r.nameEn : r.name}</text>
                    )}
                  </g>
                )
              })}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{
              ...
              background: `linear-gradient(135deg, ${display.color}12, ${display.color}06)`,
              border: `1px solid ${display.color}25`,
            }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                <div style={{
                  width: 44, height: 44, borderRadius: 14, flexShrink: 0,
                  background: `${display.color}20`, border: `1px solid ${display.color}30`,
                  display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22,
                }}>📍</div>
                <div>
                  <div style={{ color: 'var(--text)', fontWeight: 800, fontSize: 20 }}>{en ? display.nameEn : display.name}</div>
                  <div style={{ color: display.color, fontSize: 12, fontWeight: 600 }}>
                    {en ? 'Growth Point program region' : 'Регион программы «Точка Роста»'}
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
                {[
                  { value: display.vacancies.toLocaleString(), label: en ? 'Vacancies' : 'Вакансий', icon: '💼' },
                  { value: display.partners, label: en ? 'Partners' : 'Партнёров', icon: '🤝' },
                  { value: display.participants.toLocaleString(), label: en ? 'Participants' : 'Участников', icon: '🙋' },
                ].map((s, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{ color: display.color, fontWeight: 800, fontSize: 18 }}>{s.value}</div>
                    <div style={{ color: 'var(--text-2)', fontSize: 10, marginTop: 2 }}>{s.label}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="card" style={{ padding: '18px 20px' }}>
              <div style={{ color: 'var(--text-2)', fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 12 }}>
                {en ? 'Top tracks in the region' : 'Популярные треки в регионе'}
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {(en ? display.topTracksEn : display.topTracks).map((track, i) => (
                  <div key={track} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    <div style={{
                      width: 22, height: 22, borderRadius: 6, flexShrink: 0,
                      background: `${trackColors[track]}18`,
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      color: trackColors[track], fontSize: 11, fontWeight: 800,
                    }}>{i + 1}</div>
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 3 }}>
                        <span style={{ color: 'var(--text)', fontSize: 13, fontWeight: 600 }}>{track}</span>
                        <span style={{ color: trackColors[track], fontSize: 12, fontWeight: 700 }}>{90 - i * 15}%</span>
                      </div>
                      <div style={{ height: 4, borderRadius: 99, background: 'var(--border)', overflow: 'hidden' }}>
                        <div style={{ height: '100%', borderRadius: 99, background: trackColors[track], width: `${90 - i * 15}%` }} />
                      </div>
                    </div>
                  </div>
                ))}
            ...
            {/* Region list quick nav */}
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
              {regions.map(r => (
                <button key={r.id} onClick={() => setSelected(r)} style={{
                  padding: '5px 12px', borderRadius: 20, border: 'none', cursor: 'pointer',
                  fontFamily: 'Inter, sans-serif', fontSize: 12, fontWeight: 600,
                  background: selected?.id === r.id ? `${r.color}18` : 'var(--bg-el)',
                  color: selected?.id === r.id ? r.color : 'var(--text-2)',
                  outline: selected?.id === r.id ? `1.5px solid ${r.color}40` : '1px solid var(--border)',
                  transition: 'all 0.15s',
                }}>{en ? r.nameEn : r.name}</button>
              ))}
            </div>
          </div>
        </div>
